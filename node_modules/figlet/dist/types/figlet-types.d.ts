export type FontName = "1Row" | "3-D" | "3D Diagonal" | "3D-ASCII" | "3x5" | "4Max" | "5 Line Oblique" | "Standard" | "Ghost" | "Big" | "Block" | "Bubble" | "Digital" | "Ivrit" | "Mini" | "Script" | "Shadow" | "Slant" | "Small" | "Speed" | "Tinker-Toy" | string;
export type KerningMethods = "default" | "full" | "fitted" | "controlled smushing" | "universal smushing";
...
export type FittingProperties = "hLayout" | "hRule1" | "hRule2" | "hRule3" | "hRule4" | "hRule5" | "hRule6" | "vLayout" | "vRule1" | "vRule2" | "vRule3" | "vRule4" | "vRule5";
...
export type CallbackFunction<T = string> = (error: Error | null, result?: T) => void;
export declare const LAYOUT: {
    readonly FULL_WIDTH: 0;
    readonly FITTING: 1;
    readonly SMUSHING: 2;
    readonly CONTROLLED_SMUSHING: 3;
};
export type LayoutType = (typeof LAYOUT)[keyof typeof LAYOUT];
export interface FigChar {
    [charCode: number]: string;
}
export declare class FigletFont {
